#!/usr/bin/env python3
"""Run the v4.3.0 frontend and multiplayer backend locally."""
...
def main() -> None:
    ...
    url = f"http://localhost:{HTTP_PORT}/?version=4.3.0&t={int(time.time())}"
    print("=" * 72)
    print("VOXEL MULTIPLAYER HILLS v4.3.0 — LOCAL DEVELOPMENT")
    print(f"Game: {url}")
